      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 glow-text">
            Hoeveel leads mis jij
            <span className="text-primary block mt-2">deze week?</span>
          </h2>

          <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            Vul je gegevens in en Alexander belt je binnen 1 minuut terug met een demo.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg px-10 py-6 glow-gold group"
